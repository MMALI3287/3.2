...
public class ShortestRemainingTimeNext {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numberOfProcesses; i++) {
            System.out.print("Enter CPU burst time and Arrival time for process " + (char) ('A' + i) + ": ");
        ...
        PriorityQueue<Process> queue = new PriorityQueue<>(Comparator.comparingInt(p -> p.remainingBurstTime));
